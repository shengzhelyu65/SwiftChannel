...
from Models.model_zoo import return_model
...
def main():
    ...
    for path in os.listdir("Experiments/"):
        if ex_date in path and ex_time in path and ex_model in path and ex_loss in path and f"FRE_{fre_com}" in path and f"SPA_{spa_com}" in path:
            ...
            model_path = "Experiments/" + path + '/model_checkpoint_best_eval.pth'
            break
    ...
    shutil.copyfile('4_test_before_qat.py', ex_folder + '/test_result/test_before_qat_' + current_time + '.py')
